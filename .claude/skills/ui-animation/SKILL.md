---
name: ui-animation
description: "UI motion reference library (111 production-ready effects). Translates product scenarios (slow page load, no interaction feedback, page feels flat/static, wants a premium feel) into concrete UI animation recipes with copy-paste code. Use when adding motion, transitions, loading states, hover/press feedback, scroll effects, or hero animations to any web UI. Reference files under ref/ cover entrance, feedback, scroll, text, background and 3D-feel effects."
---
