...
description: Design smooth, professional web animations — page transitions, component enter/exit, hover and micro-interactions, scroll-triggered effects, loading states — using CSS and Framer Motion patterns. Use when designing or reviewing UI animation for web apps.
---
