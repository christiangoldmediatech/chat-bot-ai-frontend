...
const platformKpis = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      value: totals?.meetingsNewChains ?? 0,
      delta: totals && previous ? deltaPct(totals.meetingsNewChains, previous.meetingsNewChains) : null,
    ...
    },
    {
      ...
      value: totals?.meetingsCancelledChains ?? 0,
      delta: totals && previous ? deltaPct(totals.meetingsCancelledChains, previous.meetingsCancelledChains) : null,
      spark: [] as number[],
      color: '#f43f5e',
    },
  ]
