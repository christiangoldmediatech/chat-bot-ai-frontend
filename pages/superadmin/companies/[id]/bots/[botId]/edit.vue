...
<template>
  <div>
    <NuxtLink :to="`/superadmin/companies/${tenantId}/bots/${botId}`" class="text-sm text-slate-400 hover:text-slate-200">{{ $t('admin.botEdit.back') }}</NuxtLink>
    <h1 class="mt-2 text-2xl font-semibold text-slate-100 tracking-tight">{{ $t('admin.botEdit.title') }}</h1>
    ...
    <div v-else class="mt-6 grid grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)] lg:items-start gap-6">
        ...
        <ol class="mt-4 space-y-3">
          ...
          <li class="flex gap-2.5">
            ...
            <div class="min-w-0">
              ...
              <p class="text-[11px] text-slate-500 mt-0.5">{{ $t('admin.botEdit.step3PasteHere') }}<span class="font-medium text-slate-300">{{ $t('admin.botEdit.step3SaveEmph') }}</span>.</p>
            </div>
          </li>
          <li class="flex gap-2.5">
            ...
            <div class="min-w-0">
              ...
              <p class="text-[11px] text-slate-500 mt-0.5">
                {{ $t('admin.botEdit.step4ConfigBody') }}
              </p>
            </div>
          </li>
          <li class="flex gap-2.5">
      ...
      <section class="rounded-2xl bg-slate-900/60 ring-1 ring-slate-800 p-6 space-y-5">
        ...
        <div>
          <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botCreate.section.nameLabel') }}</label>
          <input
            v-model="form.name"
            type="text"
            required
        ...
        <div>
          <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botCreate.section.systemPromptLabel') }}</label>
          <textarea
        ...
        <div class="flex items-center gap-2">
          ...
          <label for="isActive" class="text-sm text-slate-300">{{ $t('admin.botEdit.botActiveLabel') }}</label>
        </div>
      </section>
      ...
      <section class="rounded-2xl bg-slate-900/60 ring-1 ring-slate-800 p-6 space-y-5">
        ...
        <div>
          ...
          <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botCreate.section.phoneIdLabel') }}</label>
              <input
        ...
        <div>
          ...
          <div class="mt-3 space-y-4">
            <div>
              <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botEdit.newAccessToken') }}</label>
              <input
            ...
            <div>
              <label class="block text-sm font-medium text-slate-300">
                {{ $t('admin.botEdit.newAppSecret') }} <span class="text-slate-500 font-normal">{{ $t('admin.botCreate.section.wabaIdOptional') }}</span>
              </label>
              <input
        ...
        <div>
          ...
          <div class="mt-3">
            <div class="flex items-center justify-between">
              <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botEdit.callbackUrlLabel') }}</label>
              <CopyButton :value="callbackUrl" tone="dark" :label="$t('admin.botEdit.copyUrl')" />
            </div>
            ...
            <p class="mt-1 text-xs text-slate-500">
              {{ $t('admin.botEdit.callbackHelpBefore') }}<span class="font-mono">{{ botId }}</span>{{ $t('admin.botEdit.callbackHelpAfter') }}
            </p>
          </div>
          ...
          <div class="mt-4">
            <div class="flex items-center justify-between">
              <label class="block text-sm font-medium text-slate-300">{{ $t('admin.botEdit.verifyTokenLabel') }}</label>
              <CopyButton
