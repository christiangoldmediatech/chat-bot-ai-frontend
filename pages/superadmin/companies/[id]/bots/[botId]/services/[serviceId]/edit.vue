  ...
  <div class="max-w-2xl">
    ...
    <template v-else-if="service">
      <div class="mt-2 flex items-start justify-between gap-3">
        ...
        <button type="button" class="text-xs font-medium text-danger-600 hover:text-danger-800" @click="confirmingDelete = true">
          {{ $t('common.delete') }}
        </button>
      </div>
      ...
      <div class="mt-6 rounded-2xl border border-slate-200 bg-white/80 backdrop-blur-xl p-5">
        <h2 class="text-sm font-semibold text-slate-700 uppercase tracking-wider">{{ $t('admin.services.imageSection') }}</h2>
