...
<template>
  <div>
    <header>
      ...
      <h1 class="mt-2 text-2xl font-semibold text-slate-100 tracking-tight">My profile</h1>
      <p class="text-slate-400 mt-1 text-sm max-w-2xl">
        Your platform-admin account. Treat this credential carefully — it has global access across every tenant.
      </p>
    </header>
    ...
    <section v-if="auth.user" class="mt-6 max-w-2xl rounded-2xl bg-slate-900/60 ring-1 ring-slate-800 p-6">
      <div class="flex items-start gap-4">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="mt-2 flex flex-wrap items-center gap-2">
            ...
            <span class="text-xs text-slate-500">Global access</span>
          </div>
        </div>
      </div>
      ...
      <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div class="rounded-xl bg-slate-950 ring-1 ring-slate-800 px-3 py-2.5">
          <p class="text-[10px] uppercase tracking-wider font-semibold text-slate-500">Account ID</p>
      ...
      <div class="mt-4 flex items-start gap-2 rounded-xl bg-amber-500/5 ring-1 ring-amber-500/20 px-3 py-2.5 text-xs text-amber-200/90">
        ...
        <p class="leading-relaxed">
          This account has global access across every tenant. Use a strong, unique password and never share it.
        </p>
      </div>
    </section>
    ...
    <form class="mt-4 max-w-2xl rounded-2xl bg-slate-900/60 ring-1 ring-slate-800 p-6 space-y-5" @submit.prevent="onSubmit">
      <header class="flex items-start gap-3">
        ...
        <div>
          <h2 class="text-base font-semibold text-slate-100">Change password</h2>
      ...
      <div>
        ...
        <p v-if="form.confirmPassword && !passwordsMatch" class="mt-1 text-xs text-danger-400">Passwords don't match.</p>
      </div>
    ...
    <section class="mt-4 max-w-2xl rounded-2xl bg-slate-900/60 ring-1 ring-slate-800 p-6">
      <header class="flex items-start gap-3">
        ...
        <div>
          <h2 class="text-base font-semibold text-slate-100">Session</h2>
