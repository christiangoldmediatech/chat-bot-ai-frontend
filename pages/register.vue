...
<template>
  <div class="w-full max-w-md">
    <div class="flex flex-col items-center">
      <LurviaLogo :size="72" rounded="rounded-3xl" class="bg-white ring-1 ring-white/70 shadow-glass-lg" />
      <p class="mt-3 text-base font-semibold tracking-tight text-slate-900">LURVIA</p>
