...
/**
 * Escena animada "bandeja desbordada → LURVIAX responde a todos".
 *
 ...
 * LURVIAX y cada fila pasa a "respondido" en cascada; cierra con el resumen
...
// stage 1-4: entra cada chat · 5: pill de LURVIAX · 6-9: se resuelve cada
...
<template>
  ...
  >
    ...
    <!-- Pill de LURVIAX: entra en acción → resumen. Altura fija para no
    ...
    <div class="mt-4 flex h-10 items-center justify-center">
      ...
      >
        <LurviaxLogo :size="20" rounded="rounded-full" class="shrink-0 bg-white" />
